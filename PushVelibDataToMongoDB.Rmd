...
library(ggplot2)
ggplot(tab$serie)+aes(x=as.POSIXct(last_update,origin="1970-01-01", tz="GMT"),y=available_bikes)+geom_line()+labs(title="station 901",x="date",y="available bikes")+scale_x_date(date_labels = "%d %c")

```

Je pense qu'on a toutes les briques de bases pour commencer une app shiny de visualisation des données:
- on donne les deux adresses: départ et arrivées
